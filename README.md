...
Alternative perspective on the prediction method is **Bayesian Prediction with Copulas**. Handling **data arriving in real time** requires a flexible non-parametric model, and the Monte Carlo methods necessary to evaluate the predictive distribution in such cases can be too expensive to rerun each time new data arrives. With respect to this, Bayesian Prediction with Copulas' approach facilitates the prediction **`without computing a posterior`**. 
 ...
 - ### Concept 03> Gaussian Copula Density
   ...
   For a Dirichlet process mixture model, with `Gaussian kernel` - N(x|u, 1) - and DP prior - ![formula](https://render.githubusercontent.com/render/math?math=\alpha=\alpha,\G_0=\N(0,1/\tau)) where ![formula](https://render.githubusercontent.com/render/math?math=\rho=1/\tau) -, then the `Gaussian Copula Density` is <img src="https://user-images.githubusercontent.com/31917400/77658359-7fd56a80-6f6e-11ea-8425-cef9e6c92e70.jpg"/> In particular, we consider the following recursive sequence of predictive densities <img src="https://user-images.githubusercontent.com/31917400/77659684-44d43680-6f70-11ea-93f8-27929110970f.jpg"/> 
