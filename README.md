...
The main idea behind variational methods is to pick a **family of distributions** over the `latent variables` with **its own variational parameters**. Then, ﬁnd the setting of the parameters that makes `q` close to the posterior of interest.
